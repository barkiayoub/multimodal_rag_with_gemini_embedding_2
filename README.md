...
![RAG with Gemini Embedding 2 results](images/multimodal_rag_using_gemini_embeddings_2.jpeg)
...
![RAG with Gemini Embedding 2 architecture](images/workflow.png)
...
```text
multimodal_rag_with_Gemini_Embedding_2/
├── server.py               #  UI
...
This project was created by the collaboration of [**BARKI Ayoub**](https://github.com/barkiayoub) and [**NABIL Mohamed**](https://github.com/nabilmohamed99)
